...
export declare class Twitter {
    ...
    user(includeStatus?: boolean, includeEmail?: boolean): TwitterUser;
    status(includeUser?: boolean, includePhoto?: boolean): TwitterStatus;
    screenName(): string;
    private utcOffset;
...
export interface TwitterPhotoEntity {
    ...
    type: string;
    sizes: {
        [key: string]: TwitterPhotoEntitySize;
    };
}
